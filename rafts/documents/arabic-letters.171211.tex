...
% !cp % ~/blog/andreasmhallberg.github.io/documents/arabic-letters.$(date +y%m%d%).tex
% 171211
...
\marginnote{The \br{baseline} is marked with a red line on descending letterforms.}%
