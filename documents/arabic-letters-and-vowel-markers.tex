...
\marginnote{This chart was designed as a complement to the \textup{Alif Baa} Arabic textbook (George\-town University Press, 1995) and follows the transcription system used therein.

\smallskip
For versions with other transcription systems, see \url{http://andreasmhallberg.github.io}.}[-1cm]
\\{\small\itshape\today}
