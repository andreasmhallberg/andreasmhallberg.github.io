...
\foreach \x in {500,1000,...,\maxwc} 
    {
        ...
        \draw (\x,0) -- ++ (0,2mm) node [font=\footnotesize, anchor=east, rotate=-90] {\colorbox{\myred}{\strut\pgfmathprintnumber[assume math mode=true,precision=0]{\var}}\hspace{-1pt}0};
}
    ...
    {\draw [thin, color=white] (\x,-1) -- (\x,-115); }
        ...
        \node at (\maxwc,-115) [anchor=south east, inner sep=0pt, align=right]
        {
            \begin{minipage}{.5\textwidth}
                \raggedleft
\Huge
\strut Word and \colorbox{black!10}{\strut aya} counts\\
\strut in the Quran 
...
Names of suras are from Arberry's\\
translation. Dots mark Makkan suras.
