% For Frank Weiglets "Einfürung"
% Generate the pdf and split it with cpdf.
% !cpdf -crop "0mm 0mm 145mm 220mm" weigelt-timeline.171001.tex.pdf -o page1.pdf && cpdf -crop "145mm 00mm 290mm 220mm" weigelt-timeline.171001.tex.pdf -o page2.pdf && open page1.pdf && open page2.pdf
...
\setlength\axistobottom{6.5cm}
\newlength\axistotop
\setlength\axistotop{10cm}
...
% \phase{Pre-theoretical\\grammar}{650}{780}
    ...
    \phase{Systematisierung:\\Baṣra, Kūfa, Baġdād}{865}{1048}
    \phase{Kommentierung der Tradition, Ausbau der Darstellungsformen}{1048}{1525}
  ...
  \dynasty    {black!40}   {Fatimiden\hspace{1cm}(Ägypten)}      {909}    {1171}     {2}
  \dynasty   {black!20}   {Osmanen}      {1299}   {\fince}   {1}
  \dynasty    {black!40}   {\hspace{2em}Mamluken}       {1250}   {1517}     {2}
