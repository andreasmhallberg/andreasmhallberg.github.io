...
\end{pgfonlayer}
       ...
       % school B/K
       \node at (name.west) [yshift=.5ex, anchor = south] (school) {\MakeLowercase{\textsc{#5}}};

       % year of death
       \path (name.west) ++ (0,4em) node [rotate=-90, anchor=west] (yod) {#3} ;
...
\begin{pgfonlayer}{background}
    ...
    (#4,0) [#1]-- (#5,0);
    % label
    \node [white, yshift=\dynastyvshift+#6\dynastyheight, font=\sffamily] 
    at ({#4+(#5-#4)/2},0) {#3};
\end{pgfonlayer}
}
...
\begin{tikzpicture}[x=\textwidth/(\fince-\startce)]
    ...
    % Title
    \node at (1524, 10cm) [anchor=east]{\Huge\Large Zeittafel};
    
    \useasboundingbox (622,0) -- (\fince,0); 
    % \renewcommand\baselinestretch{.8}

\node at (670,\personh) [inner sep=0pt, anchor=south east, align=right] {\small Baṣra/Kufa/Baġdād};
    \node at (670,\personh+4em-1.5pt) [inner sep=0pt, anchor=north east, align=right] {\small gestorben};
...
% \phase{Pre-theoretical\\grammar}{650}{780}
    \phase{Vorläufer}{675}{775}
    \phase{Frühe Grammatiker}{775}{875} % p.8
    \phase{Systematisierung:\\Baṣra, Kūfa, Bagdad}{875}{1045}
    \phase{Kommentierung der Tradition, Ausbau der Darstellungsformen}{1045}{1525}


    % \dynasty{Muḥammad}{622}{632}
  \dynasty    {black!50}   {Ummayaden}      {661}    {750}      {1}
...
% List of grammarians
    ...
    \person[-1ex]{Muqātil b. Sulaimān}{767}{Korankommentar}{}
    \person[adj]{al-Ḫalīl b. Aḥmad}{786}{Kitāb al-ʿAin}{B}
    ...
    \person[adj]{Ṯaʿlab}{904}{Kitāb alfaṣīḥ}{K} % p.7
    \person{Ibn as-Sarrāǧ}{928}{ʾUṣūl an-naḥw}{B}
    % \infoboḫ{\textit{First expression of final canonical grammar.}}
    \person{az-Zaǧǧāǧī}{951}{al-ʾIḍāḥ fī ʿilal an-naḥw}{Bġ} % p 11
    \person[-1.45ex]{as-Sirāfī}{979}{Šarḥ kitāb Sībawaih}{B} % p.14 in passing
    \person[adj]{ar-Rummānī}{994}{Šarḥ kitāb Sībawaih}{} % p.14 in passing
    \person{Ibn Ǧinnī}{1002}{al-Ḫaṣāʾiṣ}{Bġ}
    ...
    \person[-1ex]{Ibn ʿUṣfur}{1271}{Mumtiʿ  fī t-taṣrīf}{} % p.73
...
70
	...
	\draw [very thick] (622, .2) -- (622, -.5) 
	  node [rotate=-90, anchor=west] {\textbf{\textit{al-Hiǧra}}~(622)};
