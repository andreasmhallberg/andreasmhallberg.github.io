...
\end{pgfonlayer}
       ...
       % school B/K
       \node at (name.west) [outer sep=0pt, anchor = south] (school) {\MakeLowercase{\strut\textsc{#5}}};
...
\begin{center}
    {\Large\bfseries Entwicklung der arabischen Grammatiktradition\\[\smallskipamount]
...
\begin{tikzpicture}[x=\textwidth/(\fince-\startce)]
    ...
    \useasboundingbox (622,-4) -- (\fince,7); 
    % \renewcommand\baselinestretch{.8}

\node at (670,\personh) [outer sep=0pt, anchor=south east, align=right] {\small Baṣra/Kufa/Baġdād};
