...
\newcommand{\explaingrayrow}{%
  The gray row shows the shortened form applicable also to 2ms, 2fs, 1pl, 2mpl, and 3fpl in past tense, i.e with \textarabic{ـتَ}\,, \textarabic{ـتِ}\,, \textarabic{ـنا}\,, \textarabic{ـتم}\,, or~\textarabic{ـن}\,. Example verbs are taken from {\upshape A Frequency Dictionary of Arabic} by Tim Buckwalter and Dilworth Parkinson (Routledge 2011).%
}
...
\vfill
 ...
 \begin{minipage}{\textwidth}
  ...
  \itshape
  \begin{multicols}{3}
    Hollow verbs have \textarabic{و} or~\textarabic{ي} as the middle root consonant. In form~\textsc{i} there two different inflectional classes for verbs with the middle root~\textarabic{و} and one for verbs with the middle root~\textarabic{ي}. In~\textsc{ii--x} all verbs with hollow roots are inflected the same way regardless of whether the middle root is \textarabic{و} or~\textarabic{ي}. Note that hollow verbs in forms \textsc{ii, iii, v} and~\textsc{vi} are inflected exactly like strong verbs.
    \explaingrayrow 
  \end{multicols}
 \end{minipage}
...
\begin{minipage}{\textwidth}
  ...
  \itshape
  \begin{multicols}{3}
  Defective verbs have \textarabic{و} or~\textarabic{ي} as the third root consonant. In form~\textsc{i} there are two different inflectional classes for verbs with~\textarabic{ي} as the third root and one for verbs with~\textarabic{و} as the third root. In \textsc{ii--x} the form is the same regardless of whether the final root is \textarabic{و} or~\textarabic{ي}. The nunation~\textarabic{ـٍ} in participles is replaced with~\textarabic{ـِي} when definite or in construct state (e.g~\textarabic{قاضٍ، القاضي، قاضي بغداد}). PPs with~\textarabic{ى} are traditionally described as having an ending~\textarabic{ـً}\,. This is however rarely enunciated or produced in print.
    \explaingrayrow
  \end{multicols}
\end{minipage}
...
\begin{Arabic}
  \begin{tabularx}{\textwidth}{lYYYYYYYYYYYc}
    ...
    \toprule
\Large
    &\large \textenglish{I \itshape y-a}    &\large \textenglish{I \itshape y-b}&\large\textenglish{I \itshape w}&\large \textenglish{II} &\large \textenglish{III}               &\large \textenglish{IV} &\large \textenglish{V} &\large \textenglish{VI} &\large \textenglish{VII} &\large \textenglish{VIII} &\large \textenglish{(IX)} &\large \textenglish{X} \\

\midrule
\textenglish{Past}          & \f\n ـى        &\f\k ـيَ      & \f\n ـا            & \f \sf ـى     & \n ـا\f ـى      & أَ\s\n ـى     & تَـ\f\s ـى       & تَـ\n ـا\n ـى       & اِنْـ\f\n ـى      & اِ\s ـتَـ\s\n ـى  & اِ\s\f\sf     & اِسْتَـ\s \n ـى \\   
\rc\textenglish{Past 1s}    & \f\f\s ـتُ      & \f\k ـيتُ    & \f\f\s ـتُ          & \f \sf ـيْتُ    & \n ـا\f ـيْتُ     & أَ\f\f ـيْتُ    & تَـ\f\sf ـيْتُ     & تَـ\n ـا\f ـيْتُ      & اِنْـ\f\f ـيْتُ     & اِ\s ـتَـ\f ـيْتُ & اِ\s\f ـيْتُ   & اِسْتَـ\n\f ـيْتُ \\  
\textenglish{Present}       & يَـ\s\k ـي      & يَـ\s\n ـى   & يَـ\s\d ـو          & يُـ\f \sk \n   & يُـ\n ـا\k \n    & يُـ\k ـِيـ\n   & يَتَـ\f\sf\n      & يَتَـ\n ـا\f\n       & يَنْـ\n ـا\n      & يَـ\s ـتَـ\k\n    & يَـ\s\f\sh    & يَسْتَـ\k ـيـ\n \\  
\hhline{~---}                                                                                                                                                                                                                    
\textenglish{\textit{maSdar}} & \multicolumn{3}{|c|}{\textenglish{Irregular}}   & تَـ\s \k ـية   & مُـ\n ـا\n ـاة   & إِ\s\n ـاء    & تَـ\f\skn        & تَـ\n ـا\kn         & اِنْـ\k\n ـاء     & اِ\s ـتِـ\n ـاء   & اِ\s\k\n ـا\n & اِسْتِـ\s\n ـاء \\
\textenglish{AP}    & \multicolumn{3}{|c|}{\n ـا\kn}                            & مُـ\f \skn     & مُـ\n ـا\kn      & مُـ\s\kn      & مُتَـ\f\skn       & مُتَـ\n ـا\kn        & مُنْـ\f\kn        & مُـ\s ـتَـ\kn     & مُـ\s\f\sh    & مُسْتَـ\s\kn \\  

\hhline{~---}                                                                                                                                                                                                                    
\textenglish{PP}   & مَـ\s\k ـيّ & مَـ\s\k ـيّ &مَـ\s\d ـوّ                           & مُـ\f\sh ـى    & مُـ\n ـا\n ـى    & مُـ\n ـا\n ـى& مُتَـ\f\sh ـى      & مُتَـ\n ـا\n ـى      & مُنْـ\f ـا\n ـى   & مُـ\s ـتا\n ـى   &              & مُسْتَـ\n ـا\n ـى\\   
\midrule                                                                                                                                                                                                                         
